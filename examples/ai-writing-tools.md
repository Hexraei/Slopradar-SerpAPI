...
| Rule | Pages | Hits |
|---|---|---|
| `structure.tricolon-list` | 4 | 37 |
| `vocab.craft` | 4 | 11 |
| `vocab.enhance` | 3 | 6 |
| `structure.from-x-to-y` | 3 | 5 |
| `vocab.streamline` | 3 | 4 |
...
| `structure.from-x-to-y` | structure | 2 | ...Voice (formerly Boss Mode) tool learns from your existing content to get the right tone, style... |
| `structure.heres-the-thing` | structure | 1 | ...rtain features and qualities in common. Here’s what to look out for. A user-friendly interf... |
...
- URL: https://ilampadmanabhan.medium.com/best-ai-writing-tools-2025-i-tested-8-ai-writers-with-detection-software-46702c34e0f0
- Slop score: **n/a** (Not scored)
- Words scored: 0, weighted hits per 1k words: 0.0
- Skipped: HTTP 403
...
- URL: https://deepai.org/chat/writer
- Slop score: **70** (Sloppy)
- Words scored: 166, weighted hits per 1k words: 30.1

| Rule | Category | Hits | Example |
|---|---|---|---|
| `structure.not-just-x-but-y` | structure | 1 | ...ol will help you craft scripts that are not only compelling but also meaningful. Upload Succes... |
| `vocab.craft` | inflated-vocabulary | 1 | ...gence, this powerful tool will help you craft scripts that are not only compelling bu... |
| `vocab.unparalleled` | inflated-vocabulary | 1 | ...s your ultimate writing companion! With unparalleled creativity and intelligence, this power... |
...
| Rule | Category | Hits | Example |
|---|---|---|---|
| `phrase.elevate-your` | stock-phrase | 6 | ...transformed in seconds! Grammar Checker Elevate your writing with our free AI grammar checke... |
| `vocab.craft` | inflated-vocabulary | 5 | ...thoughts, and our AI writing tools will craft the marketing copy effortlessly. It’s a... |
| `vocab.effortlessly` | inflated-vocabulary | 16 | ...ing tools will craft the marketing copy effortlessly. It’s as straightforward as that. Writi... |
| `vocab.elevate` | inflated-vocabulary | 6 | ...transformed in seconds! Grammar Checker Elevate your writing with our free AI grammar c... |
...
| `vocab.seamlessly` | inflated-vocabulary | 1 | ...Unlock emotions with our AI translator! Seamlessly convert text to expressive emojis. Comm... |
| ... | | | 3 more rules in the JSON report |

### 6. Free AI Writing Resources

- URL: https://www.scribbr.com/ai-writing/
- Slop score: **n/a** (Not scored)
- Words scored: 0, weighted hits per 1k words: 0.0
- Skipped: HTTP 403
...
| Rule | Category | Hits | Example |
|---|---|---|---|
| `structure.heres-the-thing` | structure | 10 | ...ince it will just make your work worse. Here’s what you actually need: An AI writer tool th... |
| `structure.the-best-part` | structure | 12 | ...eatures of Muse that make it stand out: The best part? You can further: Adjust the style, ton... |
| `structure.rhetorical-reveal` | structure | 4 | ...use these models behind the scenes. And the best part? Over time, both ChatGPT and Claude have... |
| `structure.em-dash` | structure | 26 | ...st writers I hired from Fiverr: Jasmina — writing coach and mentor Daniella H — w... |
| `phrase.let-s-dive-into` | stock-phrase | 2 | ...rol + revisions + human expertise. Now, let’s dive into the recommendations for the best AI wr... |
...
- URL: https://www.reddit.com/r/WritingWithAI/comments/1qs5n13/what_is_actually_the_best_ai_writing_tools_right/
- Slop score: **n/a** (Not scored)
- Words scored: 0, weighted hits per 1k words: 0.0
- Skipped: blocked by robots.txt

_Scores are deterministic style-pattern scores, not a claim about who wrote the page._